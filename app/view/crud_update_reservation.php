...
<head>
    ...
    <title>mis à jour de réservation</title>
</head>
<body>
    <!-- authentification -->
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-8 col-xl-6 text-center">
                <h2 class="mt-0">Mettez à jour votre reservation:</h2>
                <hr class="divider"/>
            </div>
        </div>
            <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                <div class="col-lg-6">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <!-- Submit Button-->
                        <div class="d-grid">
                            <button class="btn btn-primary rounded-5 btn-xl" type="submit">Modifier</button>
                        </div>
                    </form>
                    <div>
                        <!-- Return Button-->
